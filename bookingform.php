<?php
    ...
    if(isset($_GET['id'])) {
        $methodid = $_GET['id'];
        $sql = "SELECT * FROM service WHERE SERVICE_ID = '$methodid'";
        ...
        if($retrieve) {
            foreach($retrieve as $row) {
                $name = $row['NAME'];
                $ownerid = $row['ACCT_ID'];
                $sql2 = "SELECT * FROM healer WHERE ACCT_ID = '$ownerid'";
                $retrievehealer = $conn->query($sql2)->fetchAll();
                if($retrievehealer) {
                    foreach($retrievehealer as $row2) {
                        $clinicsched = $row2['CLINICDAYS']. " (" .$row2['CLINICHOURS']. ")";
                    }
                }
            }
        }
...
<body class="addHealer" onload="initialize();">
                ...
                <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8">
                                        <div id="loginForm">
                                                <h1 class="wow slideInDown">New Booking Form</h1>
                                                <!--            registration form    -->
                                                <form class="center-block" action="queries/booknow.php" method="post">
                                                        <!--    Service id-->
                                                        <div class="form-group">
                                                                Method's ID
                                                                <input class="form-control wow lightSpeedIn" id="methodid" name="methodid" value="<?php echo $methodid; ?>" placeholder="Method ID" type="text" required readonly > </div>
                                                        <div class="message" id="sidMessage"></div>
                                                        <!--    Owner id-->
                                                        <div class="form-group">
                                                                Owner's ID
                                                                <input class="form-control wow lightSpeedIn" id="ownerid" name="ownerid" value="<?php echo $ownerid; ?>" placeholder="Owner ID" type="text" required readonly > </div>
                                                        <div class="message" id="oidMessage"></div>
                                                        <!--    name-->
                                                        <div class="form-group">
                                                                Service's Name
	...
	<!-- End of the Calendar UI here. -->
                                                    ...
                                                    <!--Appointed Date-->
                                                        <div class="form-group">
                                                                Booking Date
                                                                <input class="form-control wow lightSpeedIn" value="" id="date" name="date" placeholder="Booking Date" type="text" readonly required > </div>
                                                        <div class="message" id="adMessage"></div>
                                                        <div class="available" id="listMessage"></div>
                                                        <!--Appointed Time-->
                                                        <div class="form-group">
                                                                Booking Time
                                                                <input class="form-control wow lightSpeedIn" value="" id="bookingtime" name="bookingtime" placeholder="Booking Time" type="text" readonly required > </div>
                                                        <div class="message" id="adMessage"></div>
                                                <!--button submit-->
...
<script src="jquery/bookingformtraps.js" type="text/javascript"></script>
</body>
</html>
